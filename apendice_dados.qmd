...
passo1_buscar_deputados <- function(id_legislatura = 57) {
  ...
  return(df_deputados_partido)
}

passo2_buscar_detalhes_deputados <- function(df_deputados_partido) {
  print("Buscando detalhes de cada deputado")
...
passo3_buscar_discursos_deputados <- function(data_inicio, data_fim) {
  print("Buscando discursos de cada deputado")
...
obter_discursos_camara <- function(id_legislatura, data_inicio, data_fim) {
  df_deputados <- passo1_buscar_deputados(id_legislatura)
  df_deputados_detalhes <- passo2_buscar_detalhes_deputados(df_deputados)
  df_discursos <- passo3_buscar_discursos_deputados(data_inicio, data_fim)
  return(df_discursos)
}
```
