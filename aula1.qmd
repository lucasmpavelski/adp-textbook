...
<iframe width="100%" height="315" src="https://cran-r.c3sl.ufpr.br/">
...
```{r}
# Este é um comentário, não será executado
```
...
O nome da variável deve começar com uma letra e pode conter letras, números, underscore e ponto:
...
Uma **função** é um trecho de código "auto-contido" que possui um nome, geralmente empregado para uso de operações comuns no código.
